    ...
    def run(self):
        ...
        try:
            ...
            while self.running:
                try:
                    # Parse URL
                    if self.url.startswith("http") and len(self.transcode_cmd) == 0:
                        # HTTP connection
...
class ProxyServer:
    ...
    def initialize_channel(self, url, channel_id, user_agent=None, transcode_cmd=None):
